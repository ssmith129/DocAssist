    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-gray-50 h-[72px] flex items-center justify-between px-7">
          <h1 className="text-[28px] font-bold text-gray-900 leading-[34px] tracking-[-0.4px]">
            {title}
          </h1>
          ...
          <div className="flex items-center space-x-6">
            ...
            <button className="relative w-10 h-10 p-0 bg-transparent border-none cursor-pointer">
              <svg
                className="w-5 h-5 text-gray-700 stroke-[1.5] mx-auto"
                width="19"
                height="21"
                viewBox="0 0 19 21"
                fill="none"
