    ...
    <Card className="transition-all duration-200 border-gray-200">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1">
              ...
              {!isCompact && (
                <p className="text-sm text-hc-text-tertiary mt-1">
      ...
      <CardContent className="space-y-4">
        ...
        {!isCompact && (
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="font-medium text-hc-text-primary">
                {patient.location}
              </p>
            </div>
            <div>
          ...
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-1">
                  <span className="hc-text-vital-signs text-base">
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <TrendIcon
                    trend={patient.vitalSigns.trends.oxygenSaturation}
                  />
                </div>
              </div>
            </div>
        ...
        {patient.allergies.length > 0 && isDetailed && (
          <div>
            <h4 className="text-sm font-medium text-hc-text-primary mb-2">
              Allergies
            </h4>
