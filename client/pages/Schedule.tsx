          ...
          <Card className="shadow-lg">
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg font-bold text-gray-700">{currentMonth}</CardTitle>
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <CardTitle className="text-lg font-bold text-gray-700">
                  Today's Schedule <span className="text-gray-400 font-normal">({appointments.length} appointments)</span>
                </CardTitle>
                <div className="flex space-x-2">
                  <Button size="sm" variant="outline">Day</Button>
                  <Button size="sm" variant="outline">Week</Button>
                  <Button size="sm" className="bg-violet-600 text-white">Month</Button>
                </div>
              </div>
            </CardHeader>
            <CardContent>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-4">
                        <div className="text-center">
                          <div className="text-lg font-bold text-violet-600">{appointment.time}</div>
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">{appointment.physician}</p>
                          </div>
                        </div>
                      </div>
