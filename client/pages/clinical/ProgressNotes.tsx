...
const progressNotes = [
  {
    ...
    status: "signed",
    subjective:
      "Patient reports feeling much better since starting new medication. No chest pain or shortness of breath.",
    objective:
      "Vital signs stable. Blood pressure 120/80. Heart rate 72 bpm regular. Lungs clear to auscultation.",
    assessment:
      "Hypertension well controlled on current regimen. Patient responding well to treatment.",
  ...
  },
  {
    ...
    status: "draft",
    subjective:
      "Patient reports minimal pain at surgical site. Denies nausea or vomiting.",
    objective:
      "Surgical site clean and dry without signs of infection. Minimal swelling present.",
    assessment:
      "Post-operative day 2 following appendectomy. Recovery progressing as expected.",
  ...
  },
  {
    ...
    status: "signed",
    subjective:
      "32-week pregnant female with no acute complaints. Reports good fetal movement.",
    objective:
      "Fundal height appropriate for gestational age. Fetal heart rate 140 bpm.",
          ...
          <Card className="shadow-lg">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-lg font-bold text-gray-700">
                    Progress Note - Sarah Johnson
                  </CardTitle>
                  <p className="text-sm text-gray-600">
                    MRN-001234 • January 21, 2024 • 10:30 AM
                  </p>
                </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="flex-1">
                  <h3 className="font-medium text-gray-900">
                    Sarah Johnson, 45 years old
                  </h3>
                  <p className="text-sm text-gray-600">
                    Room 302-A • Dr. Smith • Hypertension, Type 2 Diabetes
                  </p>
                </div>
